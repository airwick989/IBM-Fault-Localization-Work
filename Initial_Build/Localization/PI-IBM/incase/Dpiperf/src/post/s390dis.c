 ...
 *
 * Description:   Disassembles one PPC instruction.
 *
 * Output:
 *                return
...
int inst_type(char * opc) {
   ...
   if(     strncmp(opc, "basr", 4) == 0) oc = 1;
   else if(strncmp(opc, "br"  , 2) == 0) oc = 2;
   else if(strncmp(opc, "j"   , 1) == 0) oc = 3;
   else if(strncmp(opc, "br"  , 4) == 0) oc = 4;
   else                                  oc = 5;
