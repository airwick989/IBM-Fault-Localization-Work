...
struct JNINativeInterface_ {
	...
	void (JNICALL * AddModuleReads)(JNIEnv *env, jobject fromModule, jobject toModule);
	jboolean (JNICALL * CanReadModule)(JNIEnv *env, jobject fromModule, jobject toModule);
};
struct JNIEnv_ {
	...
	void AddModuleReads(jobject fromModule, jobject toModule) { functions->AddModuleReads(this, fromModule, toModule); }
	jboolean CanReadModule(jobject fromModule, jobject toModule) { return functions->CanReadModule(this, fromModule, toModule); }
#endif
};
